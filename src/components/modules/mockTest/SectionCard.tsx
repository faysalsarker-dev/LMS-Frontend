...
export const SectionCard = ({ section, onRefetch }: SectionCardProps) => {
    ...
    return (
        <Card className={`group relative rounded-3xl border-2 ${meta.border} hover:border-primary/40 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 bg-white overflow-hidden`}>
            <CardContent className="p-0">
                <div className="p-6">
                    <div className="flex justify-between items-start mb-4">
                        <div className={`p-4 rounded-2xl ${meta.bg} ${meta.color} group-hover:scale-110 transition-transform duration-300`}>
                            {meta.icon}
                        </div>
                        <Button
                            variant="ghost"
                    ...
                    <div className="space-y-2">
                        <Badge variant="secondary" className={`capitalize text-[10px] h-5 px-2 font-bold ${meta.bg} ${meta.color} border-none`}>
                            {meta.label} Part
                        </Badge>
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-6">
                        <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                            <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider mb-1">Questions</p>
                        ...
                        <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                            <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider mb-1">Time Limit</p>
                            <div className="flex items-center gap-1.5 font-bold">
