...
const [submitMockTest] = useSubmitMockTestMutation();
  ...
  if (submitted && results) {
    if (section.name === "listening") {
      return <ListeningResult results={results as any} questions={questions} slug={slug!} />;
    }
    if (section.name === "reading") {
      return <ReadingResult results={results as any} questions={questions} slug={slug!} />;
    }
    if (section.name === "writing") {
      return <WritingResult results={results as any} questions={questions} slug={slug!} />;
    }
