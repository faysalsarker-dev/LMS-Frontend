...
import { SectionCard } from "@/components/admin/mocktest/SectionCard";
import { UpdateMockTestDialog } from "@/components/admin/mocktest/UpdateMockTestDialog";
...
import { DeleteMockTestDialog } from "@/components/admin/mocktest";
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Badge
                    variant={mockTest.isActive ? "default" : "destructive"}
                  >
                    {mockTest.isActive ? "Active" : "Inactive"}
                  </Badge>
                  <span className="text-xs text-muted-foreground">
                    Updated{" "}
                    {format(new Date(mockTest.updatedAt), "dd MMM yyyy")}
                  </span>
                </div>
              </div>
            </div>
